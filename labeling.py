...
if __name__ == '__main__':
    labels_path = '../BENDR_datasets/labels/SA047_labels.csv'
    #################################
    ...
    for i, txt in enumerate(rec_names):
        ax.annotate(txt[6:], (PANSS_posit[i], mean_2_SAPS[i]), fontsize=10)
    plt.xlabel('PANSS positive', fontsize=12)
    plt.ylabel('SAPS global', fontsize=12)
    ...
    ax.set_title('Labeling of {}'.format(labels_path[-16:-11]), fontsize=12)
